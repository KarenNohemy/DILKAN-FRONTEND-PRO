...
export class proyectoService {
  ...
  actualizarProyecto(id: string, proyectoDto:any):  Observable<any>{
    return this.http.put<any>(`${this.apiUrl}/actualizar/${id}`, proyectoDto);
  }
  ...
  getProyectoName(nombre: string) {
    return this.http.get<any>(`${this.apiUrl}//listar/proyecto/${nombre}`);
  }
  ...
  getProyectoColaborador(colaborador: string) {
    return this.http.get<any>(`${this.apiUrl}/listar/proyectos/colaborador/${colaborador}`);
  }


  //Metodo para agregar colaborador a un proyecto
  agregarColaborador(id:string, proyectoDto:any):  Observable<any> {
    return this.http.put<any>(`${this.apiUrl}/agregarColaborador/${id}`, proyectoDto);
   }
